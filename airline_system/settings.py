...
SECRET_KEY = 'django-insecure-(n%zsvzp#qzv^0=7*3^jll2blnq9yjnavvughj!i1s9vcdk0@m'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Specify your template directory here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#         'CLIENT': {
#             'host': 'mongodb+srv://youtubepy:youtubepy>@cluster0.hlekbr4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0',
#             'ssl': True,
#         },
#     }
# }
...
# MONGO_URI = 'mongodb://youtubepy:youtubepy@localhost:27017/Airline%20Database'
...
DEFAULT_FROM_EMAIL = 'khotshubham393@gmail.com'
